...
function four_4to6_custom_block_example_enqueue($hook) {
	wp_enqueue_style(
		...
		plugins_url( 'front_style.css', __FILE__ ), // style.css: This file styles the block on the frontend.
		array( ), // Dependencies, defined above.
		filemtime( plugin_dir_path( __FILE__ ) . 'front_style.css' ) // filemtime ? Gets file modification time.
	);
}
